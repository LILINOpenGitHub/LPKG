...
| | The shell script will add start or stop parameter for after your shell script automatically.  For example: /lpr/lilinshell.sh start  /lpr/lilinshell.sh stop |
